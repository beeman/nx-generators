    ...
    source.getClass(targetClass).addMethods([
      {
        ...
        name: createMethod,
        parameters: [{ name: 'input', decorators: [{ name: 'Args', arguments: [`'input'`],  }], type: `${names(name).className}CreateInput` }],
        statements: [`${statement}${createMethod}(input)`],
      },
      {
        decorators: [{ name: `Mutation`, arguments: [`() => ${names(name).className}`, '{ nullable: true }'] }],
        name: deleteMethod,
        parameters: [{ name: `${idProperty}`, type: 'string', decorators: [{ name: 'Args', arguments: [`'${idProperty}'`] }] }],
      ...
      },
      {
        ...
        parameters: [
          ...
          { name: 'input', decorators: [{ name: 'Args', arguments: [`'input'`] }], type: `${names(name).className}UpdateInput`},
        ],
